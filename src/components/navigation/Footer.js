...
function Footer(){
    return(
        <footer className="bg-neon" aria-labelledby="footer-heading">
        ...
        <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-pretoneon pt-8">
            <p className="text-base text-pretoneon xl:text-center">&copy; 2023 Com creatividade Edson, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    )
