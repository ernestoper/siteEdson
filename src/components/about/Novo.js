import qeu from "../../assets/img/qeu.png";

function novo (){
    return (


    <div className="relative z-0 flex items-center overflow-hidden bg-white dark:bg-gray-800">
        <div className=" relative flex px-6 py-16 mx-auto">
            ...
            <div className="absolute  hidden sm:block sm:w-1/3 lg:w-full">
                <img src={qeu} alt='' className="h-full w-full max-w-xs m-auto md:max-w-sm"/>
            </div>
        </div>
    </div>
// </main>
